...
const Hero: React.FC<HeroProps> = ({ isHelloAnimationComplete, onAnimationComplete, initialColor, finalColor }) => {
  ...
  return (
    <div ref={heroRef} className="hero-container h-screen text-black flex flex-col justify-center items-start p-4 w-full overflow-hidden" style={{ backgroundColor }}>
      <div className="w-full">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black leading-none mb-2">
          my name is
        </h1>
        <h2 className="text-8xl sm:text-9xl md:text-11xl lg:text-13xl xl:text-15xl 2xl:text-17xl font-black leading-none mb-0" style={{ fontSize: 'min(20vw, 20vh)' }}>
        Fernando Costa.
        </h2>
        <div className="slide-left mb-2">
          <h3 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-10xl font-black leading-none" style={{ transform: 'translateX(-100%)' }}>
